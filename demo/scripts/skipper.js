...
(function() {
  ...
  root.Skipper = function(opts) {
    ...
    member = {
      ...
      fields: function(form_element, skips) {
        var data, data_fields, elem, elems, error2, invalid_fields, l, len1, len2, len3, m, msg, msgs, n, parse_field, ref, status;
        try {
      ...
      mailto: function(action, subject, mail_fields) {
        var field, l, len1, mail_content, mail_data;
        action = action.split("?")[0].split('#')[0];
        subject = encodeURIComponent(subject);
        mail_content = '';
        for (l = 0, len1 = mail_fields.length; l < len1; l++) {
          field = mail_fields[l];
