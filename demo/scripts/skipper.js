...
(function() {
  var Ajax, InvalidRequestAPI, InvalidRequestData, InvalidRequestParam, InvalidRequestType, PROFILE_COOKIE_NAME, Q, ResouceNotFound, TOKEN_COOKIE_NAME, WX_LINK_COOKIE_NAME, WX_OPEN_SID, WX_OPEN_SID_COOKIE_NAME, default_options, is_exports, procces_cookie_input, procces_cookie_output, root, supCookie, utils, version;
  ...
  root.SupMember = function(opts) {
    var ajax, api, api_member, api_open, api_wx_link, app_id, do_request, e, error1, html, j, k, len, member, meta, metas, options, request_types, v, wx_open_sid;
    ...
    request_types = ['POST', 'GET', 'DELETE', 'PUT'];
    ...
    member = {
      ...
      logout: function(success, failed) {
        ...
        clean_cookies = function() {
          ...
          try {
            ...
            return supCookie.remove(WX_LINK_COOKIE_NAME);
          } catch (error2) {
            e = error2;
      ...
      register: {
        check: function(data, success, failed) {
          return do_request({
            url: api_open + '/check',
            type: 'POST',
            data: data
        ...
        join: function(data, success, failed) {
          return do_request({
            url: api_open + '/join',
            type: 'POST',
            data: data
      ...
      activity: {
        ...
        get: function(id_or_alias, success, failed) {
          return do_request({
